...
function EditLandmark(props) {
    ...
    const editLandmark = async (event) => {
        ...
        if (await validate()) {
            ...
            await actions.updateLandmark(landmarkDispatch, id, landmark);
                    ...
                    <div class="page-header page-header-light">
                        <div class="page-header-content header-elements-md-inline" style={{ height: "55px" }}>
                            <div class="page-title d-flex">
                                <h4><span class="font-weight-semibold">Edit Landmark </span></h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form onSubmit={editLandmark} onReset={resetLandmark} >

                                            <input type="hidden" name="id" value={id} />
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-2">Name <span class="text-danger">*</span></label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="name" className="form-control" placeholder="Please Enter Landmark Name"
